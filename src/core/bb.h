...
void dual_scroll_text(int, char *, char *);
...
void credits(void);
void credits2(void);
void section_transition_1(void);
void section_transition_2(void);
void section_transition_3(void);
void section_transition_4(void);
